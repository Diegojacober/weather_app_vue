...
const geWeatherData = async () => {
    try {
        const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&units=metric&appid=c4db5671ae40600b0c9d51bc8cf9977a`);
...
const weatherData = await geWeatherData();
        ...
        <div class="flex flex-col items-center text-white py-12">
            ...
            <div class="text-center">
                ...
                <img :src="`http://openweathermap.org/img/wn/${weatherData.current.weather[0].icon}@2x.png`"
                    :alt="route.params.city" class="w-[150px] h-auto">
            </div>
        </div>
